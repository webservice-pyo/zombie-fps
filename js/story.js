...
const StoryData = {
    ...
    chapter4_intro: {
        scenes: [
            ...
            {
                text: "표서준: \"잘 왔어! 근데 문제가 생겼어...\"",
                duration: 3000
            },
            {
                text: "표서준: \"좀비 무리가 몰려오고 있어. 엄청난 숫자야.\"",
                duration: 3500
            },
            {
                text: "표서준: \"우리가 막아야 해. 준비해!\"",
                duration: 2500
            },
            {
    ...
    chapter4_clear: {
        scenes: [
            ...
            {
                text: "표서준: \"좋은 소식이야. 구조 헬기가 온대!\"",
                duration: 3000
            },
            {
                text: "표서준: \"서쪽 헬기장까지 가면 돼. 하지만...\"",
                duration: 3000
            },
            {
                text: "표서준: \"그 길에 거대한 좀비가 있다는 소문이 있어.\"",
                duration: 3500
            },
            {
                text: "마지막 관문이다. 탈출하자!",
